...
const questions = [firstCategory, secondCategory];
...
const quizData = [
    {
    number: 1,
    uestion: "Who is the Head of House Stark in Season 1?",
    ...
    orrectAnswer: "C. He was beheaded"
...
function loadQuestion() {
    const questions = firstCategory[currentQuestion];
    questionElement.textContent = currentQuizData.question;

}

function checkAnswer(answer){
    if (answer === firstCategory[currentQuestion].correctAnswer) {
        score++;
    }
}

currentQuestion++;
if (currentQuestion < firstCategory.length) {
    loadQuestion();
} else   
{
   showResult();
